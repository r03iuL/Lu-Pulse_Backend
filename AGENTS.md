...
4. Create src/middlewares/logMiddleware.js - Build logRequest and logError; plug into src/app.js. _(Note: Mount logRequest at the very top of the stack, and logError at the absolute bottom after all placeholder routes)_
...
25. Update src/app.js - Remove temp routes, import master apiRouter, point global app traffic through it. _(Note: Ensure logError remains the final middleware in the stack, positioned after the apiRouter registration)_
